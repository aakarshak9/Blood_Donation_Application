...
public class SearchActivity extends AppCompatActivity {
    ...
    TextInputEditText et_blood_group, et_city;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit_button = findViewById(R.id.search_submit_button);
    ...
    private boolean isValid(String blood_group, String city) {
        ...
        if (!valid_blood_groups.contains(blood_group)) {
            et_blood_group.setError("Blood group invalid choose from " + valid_blood_groups);
            return false;
        } else if (city.isEmpty()) {
            et_city.setError("Choose City");
            return false;
        }
        return true;
